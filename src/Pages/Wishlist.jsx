...
function Wishlist() {
  ...
  const [wishlistItems, setWishlistItems] = useState([
    {
      id: 1,
      name: 'Samsung R6 Wireless 360° Multiroom Speaker - Silver',
      price: 199,
      originalPrice: null,
      image: 'https://artoftesting.com/wp-content/uploads/2021/03/printer.png',
      dateAdded: 'June 3, 2025'
    },
    {
      id: 2,
      name: 'Bose Portable Speaker, Upto 12 hrs of playtime - Silver, 40*60cm',
      price: 180,
      originalPrice: 190,
      image: 'https://artoftesting.com/wp-content/uploads/2021/03/printer.png',
      dateAdded: 'June 3, 2025'
  ...
  const addToCart = (item) => {
    ...
    // Here you would typically add the item to cart and optionally remove from wishlist
  ...
  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center">Wishlist</h1>

  <div className="absolute right-0 flex items-center text-sm text-gray-500">
    ...
    {wishlistItems.length} {wishlistItems.length === 1 ? 'item' : 'items'}
          ...
          {/* Mobile item count */}
          <div className="sm:hidden flex items-center text-sm text-gray-500 mt-2">
            <Heart className="h-4 w-4 mr-1" />
            {wishlistItems.length} {wishlistItems.length === 1 ? 'item' : 'items'}
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {wishlistItems.length === 0 ? (
          ...
          <div className="text-center py-12 sm:py-16">
            ...
            <p className="text-gray-500 mb-6">Add items you love to your wishlist and save them for later</p>
          ...
          <div className="space-y-4 sm:space-y-6">
            {wishlistItems.map((item) => (
              <div key={item.id} className="bg-white rounded-lg sm:rounded-xl shadow-sm border hover:shadow-md transition-shadow">
  ...
  <img
    src="https://artoftesting.com/wp-content/uploads/2021/03/printer.png"
    alt="icon"
