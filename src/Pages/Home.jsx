...
const categories = [
  ...
  {
    title: "Gaming",
    items: ["Digital Watches", "Smart Cameras", "Smart Phones", "Smart Speakers"],
    image:
...
const brands = [
  { id: 1, name: "LG", image: "https://upload.wikimedia.org/wikipedia/commons/0/05/LG_logo_%282015%29.svg" },
  ...
  { id: 4, name: "Boss", image: "https://upload.wikimedia.org/wikipedia/commons/6/6f/Boss_logo.svg" },
  { id: 5, name: "JBL", image: "https://upload.wikimedia.org/wikipedia/commons/4/4e/JBL_logo.svg" },
  { id: 6, name: "Apple2", image: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" },
  { id: 7, name: "Apple2", image: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" },
  { id: 8, name: "Apple2", image: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" },
  { id: 9, name: "Apple2", image: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" },
  { id: 10, name: "Apple2", image: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" },
];
...
function Home() {
   ...
   const deals = [
    {
      ...
      image: "https://img.freepik.com/premium-photo/headphones-joystick-computer-keyboard-black-table_93675-157726.jpg",
  ...
  <div className="flex flex-col lg:flex-row gap-6">
    ...
    <div
      ...
      style={{
        backgroundImage: "url('https://mattj.io/images/posts/2021-02-27_-_keyboard.gif')",
    ...
    <div
      ...
      style={{
        backgroundImage: "url('https://png.pngtree.com/thumb_back/fw800/background/20230704/pngtree-office-essentials-technology-and-gadgets-illustration-featuring-laptop-printer-camera-tablet-image_3748458.jpg')",
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <div className="bg-black/50 p-4 rounded-xl ">
        <h2 className="text-2xl lg:text-3xl font-bold mb-2">Battery Life</h2>
        <h3 className="text-2xl lg:text-3xl font-bold mb-4">Truly Wireless</h3>
        <div className="text-sm font-medium">4GB RAM | 64GB ROM | 20MP</div>
      </div>
    </div>
    ...
    <div
      className="flex-1 rounded-2xl overflow-hidden min-h-[400px] flex flex-col justify-end p-6 lg:p-8 bg-black text-white"
      style={{
        backgroundImage: "url('https://giffiles.alphacoders.com/296/2964.gif')",
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <div className="bg-black/50 p-4 rounded-xl ">
        <h2 className="text-2xl lg:text-3xl font-bold mb-2">For 4K Ultra</h2>
        <h3 className="text-2xl lg:text-3xl font-bold mb-4">RGB Backlight</h3>
        ...
        <div className={`min-h-screen mt-5 transition-colors duration-300 ${isDark ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      <div className="container mx-auto px-2 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Weekly Deal Offer Card */}
          <div className="lg:w-80 flex-shrink-0">
            <div className={`rounded-2xl p-6 border-4 border-yellow-400 ${isDark ? 'bg-gray-800' : 'bg-white'} relative overflow-hidden`}>
              <div className="absolute top-4 right-4">
                <span className="bg-yellow-400 text-black px-2 py-1 rounded text-sm font-bold">-4%</span>
              </div>
              
              <h2 className="text-xl font-bold mb-4 text-center">Weekly Deal Offer</h2>
              ...
              <div className="text-center mb-6">
                <p className="text-sm font-medium mb-4">Hurry Up! Limited Time</p>
          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <button 
                  onClick={prevSlide}
                  className={`p-2 rounded-full ${isDark ? 'bg-gray-700 hover:bg-gray-600' : 'bg-white hover:bg-gray-100'} shadow-md transition-colors ${currentIndex === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
                ...
                <button 
                  onClick={nextSlide}
                  className={`p-2 rounded-full ${isDark ? 'bg-gray-700 hover:bg-gray-600' : 'bg-white hover:bg-gray-100'} shadow-md transition-colors ${currentIndex === maxIndex ? 'opacity-50 cursor-not-allowed' : ''}`}
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                      {products.slice(slideIndex * itemsPerSlide, (slideIndex + 1) * itemsPerSlide).map((product) => (
                        <div key={product.id} className={`rounded-xl p-4 ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-lg hover:shadow-xl transition-shadow relative`}>
                          {product.discount && (
  ...
  <div className="flex justify-between items-center mb-6">
    ...
    <div className="flex gap-2">
      <button
        onClick={prevSlide}
        className={`p-2 rounded-full ${isDark ? 'bg-gray-700 hover:bg-gray-600' : 'bg-white hover:bg-gray-100'} shadow-md transition-colors`}
      >
        <ChevronLeft className="w-5 h-5" />
      </button>
      <button
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {products
              ...
              .map((product) => (
                <div
                  key={product.id}
                  className={`rounded-xl p-4 ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-md hover:shadow-lg transition-shadow relative`}
                >
                  {product.discount && (
  ...
  {deals.map((deal) => (
    ...
    >
      ...
      <div className="relative z-20 p-6 h-full flex flex-col justify-end">
        <h3 className="text-white text-xl md:text-2xl font-bold mb-1">{deal.title}</h3>
        <h4 className="text-white text-lg md:text-xl font-semibold mb-1">{deal.subtitle}</h4>
                ...
                <div className="flex-1">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    {cat.items.map((item, i) => (
                      <li key={i} className="hover:text-gray-800 transition-colors">{item}</li>
                    ))}
                  </ul>
                </div>
              ...
              {brands
                ...
                .map((brand) => (
                  ...
                  >
                    ...
                    {/* Hover Overlay */}
                    <div className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-300 ${brand.bgColor}`}></div>
                  </div>
              ))}
            </div>
          </div>
